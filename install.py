...
CONFIG_ZSHRC = os.path.join(CONFIG_DIR, '.zshrc')
...
toUserZshrc = createAppender('#', 'source', CONFIG_ZSHRC)
toUserVimrc = createAppender('"', 'source', CONFIG_VIMRC)

toConfigReadme = '''This directory was generated by {}
'''.format(REPO_URL)

toConfigVimrc = createHeader('"') + '''

" allow syntax highlighting
syntax on
'''

toConfigZshrc = createHeader('#') + '''
